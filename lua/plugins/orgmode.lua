return {
  {
    ...
    dependencies = { "akinsho/org-bullets.nvim", opts = {}, config = true },
    ft = { "org" },
    config = function()
      -- we can try our best with this but I'm still not sure what the
      -- interaction is between this config as a function key inside of
      -- the plugion spec for lazy.nvim, versus letting LazyVim (the base
      -- config) to take over.
